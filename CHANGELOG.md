...
- Create Angular project with ng: `ng new talentsbase.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`talentsbase.client.esproj`).
- Create `launch.json` to enable debugging.
- Create `nuget.config` to specify location of the JavaScript Project System SDK (which is used in the first line in `talentsbase.client.esproj`).
